                    ...
                    <table id="usersTable" class="table table-hover align-middle">
                        ...
                        <?php foreach ($users as $row): ?>
                            <?php
                                ...
                                $badgeClass = ($status == 1) ? 'success' : 'warning';
                            ...
                            <tr>
                                ...
                                <td data-status="<?= $status ?>"><span class="badge bg-<?= $badgeClass ?>"><?= $statusText ?></span></td>
                                <td><?= $isAdmin ? '<span class="badge bg-dark">Admin</span>' : 'User' ?></td>
                                <td>
