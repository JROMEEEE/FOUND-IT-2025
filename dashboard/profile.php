                            ...
                            <table id="claimRequestsTable" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($claim_requests as $row): ?>
                                        ...
                                        <tr>
                                            <td><?= htmlspecialchars($row['fnd_name']); ?></td>
                                            <td style="color: <?= $row['status'] === 'pending' ? 'gray': ($row ['status'] === 'rejected' ? 'red': ($row ['status'] === 'approved' ? 'green' :  ($row ['status'] === 'claimed' ? 'blue': 'black'))); ?>; font-weight:bold; text-transform:uppercase"><?= htmlspecialchars($row['status']); ?></span></td>
