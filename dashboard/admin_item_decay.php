        ...
        <tr>
          <th colspan="6" class="bg-white">
            <div class="d-flex justify-content-center flex-wrap align-items-center gap-2">
              ...
              <button type="button" class="btn btn-outline-dark status-btn" data-status="">All Statuses</button>
              <button type="button" class="btn btn-outline-warning status-btn" data-status="unclaimed">Unclaimed</button>
              <button type="button" class="btn btn-outline-success status-btn" data-status="claimed">Claimed</button>
              <button type="button" class="btn btn-outline-secondary status-btn" data-status="discarded">Discarded</button>
            </div>
          </th>
        </tr>
          ...
          <tr>
            ...
            <td>
              ...
              <?php elseif ($hasDiscard): ?>
                <button class="btn btn-sm btn-info showDiscardBtn"
                        data-id="<?= $item['fnd_id'] ?>">
                  Show Discard Details
                </button>
              <?php endif; ?>
            </td>
          </tr>
  ...
  <div class="modal-dialog">
    <form method="POST" class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" name="discard_item" class="btn btn-danger">Discard</button>
